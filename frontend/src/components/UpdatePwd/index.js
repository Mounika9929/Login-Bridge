...
//                     <input type="password" id="oldPwd" placeholder="Enter old Password" onChange={e => setOldPassword(e.target.value)} value={oldPassword} />
//                     <label htmlFor="newPwd">New Password</label>
//                     <input type="password" id="newPwd" placeholder="Enter New Password" onChange={e => setNewPassword(e.target.value)} value={newPassword} />
